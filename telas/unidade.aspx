<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/telas/Topo.Master" CodeBehind="unidade.aspx.vb" Inherits="VoceFazNfe.unidade" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">


    <script>

        function botao_confimar(vbotao) {
        ...
        function botao_confimar_deletar(vbotao) {
        ...
        function resposta_consulta(vresposta) {
            var vcontrole = document.getElementById('<%=cs_codigo_unidade.ClientId%>');
            var vdescricao = document.getElementById('<%=cs_descricao_unidade.ClientId%>');

            vcontrole.value = vresposta;
            vdescricao.value = "";

            anima_consulta(0, 'unidade');
        }
 ...
 <!--/////////////////////////////////////////////////// Area Principal do Programa //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
    <asp:Panel ID="pnl_principal" runat="server" BackColor="Transparent" Height="100%" Visible="True">
        ...
        <div class="row" style="width: 100%; height: 100%; padding-left: 20px; padding-top: 0px; margin-left: 0px;">
            <span style="color: red; font-family: Arial; font-size: 20px; font-weight: bold;">Cadastro de Unidade de Estoque</span>
        </div>

        <div class="row" style="width: 100%; height: 40px"></div>

        <div id="unidade_estoque" name="unidade_estoque" style="visibility: visible; width: 90%; height: 100%; background-color: transparent; margin-left: 20px; margin-right: 20px; border: solid; border-color: #177CC0; border-width: 1px; border-radius: 10px; padding: 0px 20px 20px 20px;">
            ...
            <div class="row" style="width: 100%; padding: 0px; margin: 0px; background-color: transparent; height: 100%; padding: 0px; margin: 0px">
                ...
                <div class="col" style="width: 100%; height: 100%; background-color: transparent; padding: 0px; margin: 0px">
                    ...
                    <div class="row">
                        <div class="col" style="font-family: Arial; font-size: 16px; color: #000000; font-weight: bold">Sigla da Unidade de Estoque &nbsp &nbsp
                            <img alt="" src="../Imagens/ihelp.png" style="width: 20px; height: 21px; cursor: pointer" onclick="anima_informacao(1,'unidade')" />
                        </div>
                    </div>

                    <div class="row" style="padding: 0px; margin: 0px">
                        <div class="col" style="padding: 0px; margin: 0px">
                            <i class="fa fa-filter" style="color: orange; cursor: pointer;" onclick="anima_consulta(1,'unidade')"></i>&nbsp
                               <asp:TextBox ID="cs_codigo_unidade" runat="server" CssClass="layouttexto" Style="width: 100px; padding: 0px; margin: 0px" onBlur="SetTextIn(this,0);SetDiv('unidade_estoque',0)" onFocus="SetTextIn(this,1);SetDiv('unidade_estoque',1)" MaxLength="3" AutoPostBack="True"></asp:TextBox>
                        </div>
                    </div>
            ...
            <div class="row" style="width: 100%; padding: 0px; margin: 0px; background-color: transparent; height: 100%; padding: 0px; margin: 0px">
                ...
                <div class="col" style="width: 100%; height: 100%; background-color: transparent; padding: 0px; margin: 0px">
                    ...
                    <div class="row" style="padding: 0px; margin: 0px">
                        <div class="col" style="padding: 0px; margin: 0px">
                            <asp:TextBox ID="cs_descricao_unidade" runat="server" CssClass="layouttexto" Style="width: 93%;" onBlur="SetTextIn(this,0);SetDiv('unidade_estoque',0)" onFocus="SetTextIn(this,1);SetDiv('unidade_estoque',1)" MaxLength="50"></asp:TextBox>
                        </div>
                    </div>
