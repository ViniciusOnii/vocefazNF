<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/telas/Topo.Master" CodeBehind="locaisestoque.aspx.vb" Inherits="VoceFazNfe.locaisestoque" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
          ...
          function resposta_consulta(vresposta) {
              ...
              var vcontrole = document.getElementById('<%=cs_codigo_local_estoque.ClientId%>');
      var vdescricao = document.getElementById('<%=cs_descricao_local_estoque.ClientId%>');
...
<asp:Panel ID="pnl_principal" runat="server" BackColor="Transparent" Height="100%" Visible="True">
  ...
  <div class="row" style="width: 100%; height: 100%;  padding-left:20px; padding-top: 0px; margin-left: 0px;">
      <span style="color: red; font-family: Arial; font-size: 20px; font-weight: bold;" >Local de Estoque</span>
  </div>

  <div class="row"  style="width: 100%; height: 40px"></div>

   <div id="locais_estoque" name="locais_estoque" style="visibility:visible;width:90%;height:100%;background-color:transparent;margin-left:20px;margin-right:20px;border:solid;border-color:#177CC0;border-width:1px;border-radius:10px;padding: 0px 20px 20px 20px;">
          ...
          <div class="col" style="width:100%;height:100%;background-color:transparent;padding:0px;margin:0px">
                      ...
                      <div class="row" style="padding:0px;margin:0px">
                          <div class="col" style="padding:0px;margin:0px">
                              ...
                              <asp:TextBox ID="cs_codigo_local_estoque" runat="server" CssClass="layouttexto" style="width: 100px;padding:0px;margin:0px" onBlur="SetTextIn(this,0);SetDiv('locais_estoque',0)" onFocus="SetTextIn(this,1);SetDiv('locais_estoque',1)" MaxLength="3" AutoPostBack="True" ></asp:TextBox>
                          </div>
                      </div>
     ...
     <div class="row" style="width:100%;padding:0px;margin:0px;background-color:transparent;height:100%;padding:0px;margin:0px">
          ...
          <div class="col" style="width:100%;height:100%;background-color:transparent;padding:0px;margin:0px">
                      ...
                      <div class="row" style="padding:0px;margin:0px">
                          <div class="col" style="padding:0px;margin:0px">
                              <asp:TextBox ID="cs_descricao_local_estoque" runat="server" CssClass="layouttexto" style="width: 93%;" onBlur="SetTextIn(this,0);SetDiv('locais_estoque',0)" onFocus="SetTextIn(this,1);SetDiv('locais_estoque',1)" MaxLength="50" ></asp:TextBox>
                          </div>
                      </div>
