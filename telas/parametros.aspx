<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/telas/Topo.Master" CodeBehind="parametros.aspx.vb" Inherits="VoceFazNfe.parametros" %>
...
<div class="container-fluid" style="padding: 0px; margin: 0px; width: 100%; height: 30%">
    ...
    <div class="row" style="width: 100%; height: 100%; padding: 0px; margin: 0px; background-color: transparent">
        ...
        <div style="display: block; visibility: visible; width: 100%; height: 300px; background-color: transparent; margin-left: 20px; margin-right: 20px;">


            <asp:ListBox ID="ListBox1" runat="server" Height="300px" Width="100%" Rows="80" style="border:solid;border-color:#177CC0;border-width:1px;border-radius:10px"></asp:ListBox>
                            ...
                            <div class="row" style="padding: 0px; margin: 0px">
                                <div class="col" style="padding: 0px; margin: 0px; background-color: transparent">
                                    <asp:TextBox ID="cs_certificado_digital" runat="server" CssClass="layouttexto"
                                        Style="width: 90%;" onBlur="SetTextIn(this,0)" onFocus="SetTextIn(this,1)"> </asp:TextBox>
                                </div>
                        ...
                        <div class="row" style="padding: 0px; margin: 0px">
                            <div class="col" style="padding: 0px; margin: 0px; background-color: transparent">
                                <asp:TextBox ID="TextBox1" runat="server" CssClass="layouttexto"
                                    Style="width: 100px;" onBlur="SetTextIn(this,0)" onFocus="SetTextIn(this,1)"> </asp:TextBox>
                            </div>
                        </div>
                    </div>
