<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/telas/Topo.Master" CodeBehind="cadastrodetamanhos.aspx.vb" Inherits="VoceFazNfe.cadastrodetamanhos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
          ...
          function resposta_consulta(vresposta) {
              ...
              var vcontrole = document.getElementById('<%=cs_codigo_tamanhos.ClientId%>');
      var vdescricao = document.getElementById('<%=cs_descricao_tamanhos.ClientId%>');

              vcontrole.value = vresposta;
              vdescricao.value = "";

              anima_consulta(0, 'cadastrotamanhos');
...
<asp:Panel ID="pnl_principal" runat="server" BackColor="Transparent" Height="100%" Visible="True">
  ...
  <div class="row" style="width: 100%; height: 100%;  padding-left:20px; padding-top: 0px; margin-left: 0px;">
      <span style="color: red; font-family: Arial; font-size: 20px; font-weight: bold;" >Cadastro de Tamanhos</span>
  </div>

  <div class="row"  style="width: 100%; height: 40px"></div>

   <div id="cadastro_tamanhos" name="cadastro_tamanhos" style="visibility:visible;width:90%;height:100%;background-color:transparent;margin-left:20px;margin-right:20px;border:solid;border-color:#177CC0;border-width:1px;border-radius:10px;padding: 0px 20px 20px 20px;">
     ...
     <div class="row" style="width:100%;padding:0px;margin:0px;background-color:transparent;height:100%;padding:0px;margin:0px">
          ...
          <div class="col" style="width:100%;height:100%;background-color:transparent;padding:0px;margin:0px">
                      ...
                      <div class="row">
                          <div class="col" style="font-family: Arial; font-size: 16px; color: #000000; font-weight: bold"> Código &nbsp &nbsp <img alt="" src="../Imagens/ihelp.png"  style="width: 20px; height: 21px; cursor:pointer" onclick="anima_informacao(1,'cadastrodetamanos')" /> </div>
                      </div>

                      <div class="row" style="padding:0px;margin:0px">
                          <div class="col" style="padding:0px;margin:0px">
                              <i class="fa fa-filter" style="color:orange;cursor:pointer;" onclick="anima_consulta(1,'cadastrotamanhos')"></i> &nbsp
                              <asp:TextBox ID="cs_codigo_tamanhos" runat="server" CssClass="layouttexto" style="width: 100px;padding:0px;margin:0px" onBlur="SetTextIn(this,0);SetDiv('cadastro_tamanhos',0)" onFocus="SetTextIn(this,1);SetDiv('cadastro_tamanhos',1)" MaxLength="3" AutoPostBack="True" ></asp:TextBox>
                          </div>
                      </div>
     ...
     <div class="row" style="width:100%;padding:0px;margin:0px;background-color:transparent;height:100%;padding:0px;margin:0px">
          ...
          <div class="col" style="width:100%;height:100%;background-color:transparent;padding:0px;margin:0px">
                      ...
                      <div class="row" style="padding:0px;margin:0px">
                          <div class="col" style="padding:0px;margin:0px">
                              <asp:TextBox ID="cs_descricao_tamanhos" runat="server" CssClass="layouttexto" style="width: 93%;" onBlur="SetTextIn(this,0);SetDiv('cadastro_tamanhos',0)" onFocus="SetTextIn(this,1);SetDiv('cadastro_tamanhos',1)" MaxLength="50" ></asp:TextBox>
                          </div>
                      </div>
