<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/telas/Topo.Master" CodeBehind="subgrupos.aspx.vb" Inherits="VoceFazNfe.subgrupos" %>
 ...
 <!--/////////////////////////////////////////////////// Painel de Mensagem ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
  ...
  <asp:Panel ID="pnl_principal" runat="server" BackColor="Transparent" Height="100%" Visible="True">
    ...
    <div class="row"  style="width: 100%; height: 40px"></div>
     ...
     <div id="grupo_sub_produtos" name="grupo_sub_produtos" style="visibility:visible;width:90%;height:100%;background-color:transparent;margin-left:20px;margin-right:20px;border:solid;border-color:#177CC0;border-width:1px;border-radius:10px;padding: 0px 20px 20px 20px;">
            ...
            <div class="col" style="width:100%;height:100%;background-color:transparent;padding:0px;margin:0px">
                        ...
                        <div class="row" style="padding:0px;margin:0px">
                            <div class="col" style="padding:0px;margin:0px">
                                <i class="fa fa-filter" style="color:orange;cursor:pointer;" onclick="anima_consulta(1,'grupo')"></i> &nbsp
                                <asp:TextBox ID="cs_codigo" runat="server" CssClass="layouttexto" style="width: 100px;padding:0px;margin:0px" onBlur="SetTextIn(this,0);SetDiv('grupo_sub_produtos',0)" onFocus="SetTextIn(this,1);SetDiv('grupo_sub_produtos',1)" MaxLength="3" AutoPostBack="True" ></asp:TextBox>
                            </div>
                        </div>
       ...
       <div class="row" style="width:100%;padding:0px;margin:0px;background-color:transparent;height:100%;padding:0px;margin:0px">
            ...
            <div class="col" style="width:100%;height:100%;background-color:transparent;padding:0px;margin:0px">
                        ...
                        <div class="row" style="padding:0px;margin:0px">
                            <div class="col" style="padding:0px;margin:0px">
                                <asp:TextBox ID="cs_descricao" runat="server" CssClass="layouttexto" style="width: 93%;" onBlur="SetTextIn(this,0);SetDiv('grupo_sub_produtos',0)" onFocus="SetTextIn(this,1);SetDiv('grupo_sub_produtos',1)" MaxLength="50" ></asp:TextBox>
                            </div>
                        </div>
