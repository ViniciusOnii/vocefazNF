<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/telas/Topo.Master" CodeBehind="familiadeclientes.aspx.vb" Inherits="VoceFazNfe.familiadeclientes" %>
...
function resposta_consulta(vresposta) {
    ...
    var vcontrole = document.getElementById('<%=cs_codigo_familia_cliente.ClientId%>');
        var vdescricao = document.getElementById('<%=cs_descricao_familia_cliente.ClientId%>');
  ...
  <asp:Panel ID="pnl_principal" runat="server" BackColor="Transparent" Height="100%" Visible="True">
    ...
    <div class="row"  style="width: 100%; height: 40px"></div>
     ...
     <div id="familia_cliente" name="familia_cliente" style="visibility:visible;width:90%;height:100%;background-color:transparent;margin-left:20px;margin-right:20px;border:solid;border-color:#177CC0;border-width:1px;border-radius:10px;padding: 0px 20px 20px 20px;">
       ...
       <div class="row" style="width:100%;padding:0px;margin:0px;background-color:transparent;height:100%;padding:0px;margin:0px">
            ...
            <div class="col" style="width:100%;height:100%;background-color:transparent;padding:0px;margin:0px">
                        ...
                        <div class="row" style="padding:0px;margin:0px">
                            <div class="col" style="padding:0px;margin:0px">
                                <asp:TextBox ID="cs_descricao_familia_cliente" runat="server" CssClass="layouttexto" style="width: 93%;" onBlur="SetTextIn(this,0);SetDiv('familia_cliente',0)" onFocus="SetTextIn(this,1);SetDiv('familia_cliente',1)" MaxLength="50" ></asp:TextBox>
                            </div>
                        </div>
