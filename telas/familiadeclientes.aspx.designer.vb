...
Partial Public Class familiadeclientes
    ...
    '''<summary>
    '''Controle cs_codigo_familia_cliente.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents cs_codigo_familia_cliente As Global.System.Web.UI.WebControls.TextBox

    '''<summary>
    '''Controle cs_descricao_familia_cliente.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents cs_descricao_familia_cliente As Global.System.Web.UI.WebControls.TextBox
