<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/telas/Topo.Master" CodeBehind="estadosuf.aspx.vb" Inherits="VoceFazNfe.estadosuf1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        function resposta_consulta(vresposta) {
            ...
            var vcontrole = document.getElementById('<%=cs_sigla_estado.ClientId%>');
            var vdescricao = document.getElementById('<%=cs_descricao_estado.ClientId%>');
            var vdescricao = document.getElementById('<%=cs_icms_interno.ClientId%>');
            var vdescricao = document.getElementById('<%=cs_icms_interestadual.ClientId%>');
            vcontrole.value = vresposta;
            vdescricao.value = "";

            anima_consulta(0, 'mensagemespecial');
    ...
    <asp:Panel ID="pnl_principal" runat="server" BackColor="Transparent" Height="100%" Visible="True">
        ...
        <div class="row" style="width: 100%; height: 100%; padding-left: 20px; padding-top: 0px; margin-left: 0px;">
            <span style="color: red; font-family: Arial; font-size: 20px; font-weight: bold;">%ICMS para cada Estado</span>
        </div>

        <div class="row" style="width: 100%; height: 40px"></div>

        <div id="mesangem_especial" name="mesangem_especial" style="visibility: visible; width: 90%; height: 100%; background-color: transparent; margin-left: 20px; margin-right: 20px; border: solid; border-color: #177CC0; border-width: 1px; border-radius: 10px; padding: 0px 20px 20px 20px;">
            ...
            <div class="row" style="width: 100%; padding: 0px; margin: 0px; background-color: transparent; height: 100%; padding: 0px; margin: 0px">
                ...
                <div class="col" style="width: 100%; height: 100%; background-color: transparent; padding: 0px; margin: 0px">
                    ...
                    <div class="row">
                        <div class="col" style="font-family: Arial; font-size: 16px; color: #000000; font-weight: bold">Sigla do Estado(UF) &nbsp &nbsp
                            <img alt="" src="../Imagens/ihelp.png" style="width: 20px; height: 21px; cursor: pointer" onclick="anima_informacao(1,'localestoque')" />
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding: 0px; margin: 0px">
                        <div class="col" style="padding: 0px; margin: 0px">
                            <i class="fa fa-filter" style="color: orange; cursor: pointer;" onclick="anima_consulta(1,'mensagemespecial')"></i>&nbsp
                              <asp:TextBox ID="cs_sigla_estado" runat="server" CssClass="layouttexto" Style="width: 100px; padding: 0px; margin: 0px" onBlur="SetTextIn(this,0);SetDiv('mesangem_especial',0)" onFocus="SetTextIn(this,1);SetDiv('mesangem_especial',1)" MaxLength="3" AutoPostBack="True"></asp:TextBox>
                        </div>
                    </div>
            ...
            <div class="row" style="width: 100%; padding: 0px; margin: 0px; background-color: transparent; height: 100%; padding: 0px; margin: 0px">
                ...
                <div class="col-6" style="width: 100%; height: 100%; background-color: transparent; padding: 0px; margin: 0px">
                    ...
                    <div class="row" style="padding: 0px; margin: 0px">
                        <div class="col" style="padding: 0px; margin: 0px">
                            <asp:TextBox ID="cs_descricao_estado" runat="server" CssClass="layouttexto" Style="width: 100%;" onBlur="SetTextIn(this,0);SetDiv('mesangem_especial',0)" onFocus="SetTextIn(this,1);SetDiv('mesangem_especial',1)" MaxLength="50"></asp:TextBox>
                        </div>
                    </div>
                </div>
            ...
            <div class="row" style="width: 100%; padding: 0px; margin: 0px; background-color: transparent; height: 100%; padding: 0px; margin: 0px">
                ...
                <div class="col-6" style="width: 100%; height: 100%; background-color: transparent; padding: 0px; margin: 0px">
                    ...
                    <div class="row" style="padding: 0px; margin: 0px">
                        <div class="col" style="padding: 0px; margin: 0px">
                            <asp:TextBox ID="cs_icms_interno" runat="server" CssClass="layouttexto" Style="width: 250px;" onBlur="SetTextIn(this,0);SetDiv('mesangem_especial',0)" onFocus="SetTextIn(this,1);SetDiv('mesangem_especial',1)" MaxLength="50"></asp:TextBox>
                        </div>
                    </div>
                </div>
            ...
            <div class="row" style="width: 100%; padding: 0px; margin: 0px; background-color: transparent; height: 100%; padding: 0px; margin: 0px">
                ...
                <div class="col-6" style="width: 100%; height: 100%; background-color: transparent; padding: 0px; margin: 0px">
                    ...
                    <div class="row" style="padding: 0px; margin: 0px">
                        <div class="col" style="padding: 0px; margin: 0px">
                            <asp:TextBox ID="cs_icms_interestadual" runat="server" CssClass="layouttexto" Style="width: 250px;" onBlur="SetTextIn(this,0);SetDiv('mesangem_especial',0)" onFocus="SetTextIn(this,1);SetDiv('mesangem_especial',1)" MaxLength="50"></asp:TextBox>
                        </div>
                    </div>
                </div>
