...
Partial Public Class banco
    ...
    '''<summary>
    '''Controle cs_codigo_banco.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents cs_codigo_banco As Global.System.Web.UI.WebControls.TextBox

    '''<summary>
    '''Controle cs_nome_banco.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents cs_nome_banco As Global.System.Web.UI.WebControls.TextBox
