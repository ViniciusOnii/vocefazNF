...
<%
     ...
     Set tmensagem = Server.CreateObject("ADODB.Recordset")
     tmensagem.CursorType = adOpenDynamic
     tmensagem.LockType = adLockOptimistic

     ' Abre o recordset com os dados dos subgrupos ordenados pelo código do subgrupo
     tmensagem.open "SELECT * FROM mensagemespecial ORDER BY codigo_mensagem_especial" ,erpDB

     ' Se houver registros, define a flag de dados como 1
     if Not tmensagem.eof then vflag_dados=1
%>
...
<div class="container-fluid">
    <div class="estilo_desktop">
        ...
        <div class="row" style="width:100%;height:30px;background-color:black;color:white;margin:0px;padding:0px;font-family:Arial">
            ...
            <div class="col-10" style="font-size:18px">Mensagem</div>
        </div>
        ...
        <div id="linha_<%=vlinha %>" class="row" style="width:100%;height:30px;background-color:transparent;color:black;margin:0px;padding:0px;font-family:Arial;cursor:pointer" onmouseover="altera_fundo_linha(this,1)" onmouseout="altera_fundo_linha(this,0)">
            <div class="col-2" style="font-size:18px;cursor:pointer" ondblclick="resposta_consulta('<%=tmensagem("codigo_mensagem_especial") %>')"><%=tmensagem("codigo_mensagem_especial") %></div>
            <div class="col-10" style="font-size:18px;cursor:pointer" ondblclick="resposta_consulta('<%=tmensagem("codigo_mensagem_especial") %>')"><%=tmensagem("descricao_mensagem_especial") %></div>
        </div>
    ...
    <%if vflag_dados=1 then tmensagem.MoveFirst %>
    ...
    <div class="estilo_mobile">
        ...
        <!-- Cabeçalho com a descrição das colunas da consulta -->
        <div class="row" style="width:100%;height:30px;background-color:black;color:white;margin:0px;padding:0px;font-family:Arial">
            <div class="col-2" style="font-size:14px">Codigo</div>
            <div class="col-10" style="font-size:14px">Mensagem</div>
        </div>
        ...
        <div id="linha_<%=vlinha %>_mobile" class="row" style="width:100%;height:30px;background-color:transparent;color:black;margin:0px;padding:0px;font-family:Arial;cursor:pointer" onmouseover="altera_fundo_linha(this,1)" onmouseout="altera_fundo_linha(this,0)">
            <div class="col-2" style="font-size:14px;cursor:pointer" ondblclick="resposta_consulta('<%=tmensagem("codigo_mensagem_especial") %>')"><%=tmensagem("codigo_mensagem_especial") %></div>
            <div class="col-10" style="font-size:14px;cursor:pointer" ondblclick="resposta_consulta('<%=tmensagem("codigo_mensagem_especial") %>')"><%=tmensagem("descricao_mensagem_especial") %></div>
        </div>
